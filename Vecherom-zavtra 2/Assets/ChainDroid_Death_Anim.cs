...
public class ChainDroid_Death_Anim : StateMachineBehaviour
{
	override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
	{
		...
		animator.GetComponentInParent<ChainDroid>().healthBar.transform.parent.gameObject.SetActive(false);
